...
var set_db_config = [];
var connection_name = 'msa_ins_auth';
var connection = {
	host: '',
	db_host: '',
	username: '',
...
*/
module.exports = {
	//url: 'mongodb://user-db:tap123456me@clustertest-shard-00-01-iwwfu.gcp.mongodb.net:27017/s_auth?authSource=admin',
	//url: 'mongodb://udb_inspeksi:tapinspeksiprod@dbapp.tap-agri.com:27017/s_auth?authSource=admin',
	//ssl: true,
