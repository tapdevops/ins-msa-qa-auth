/*
 ...
 |
 */
    const UserAuth =  require( _directory_base + '/app/v1.2/Http/Models/UserAuthModel.js' );
    ...
    class Kernel {
        ...
        async pushNotification ( admin, token ) {
            try {
                ...
                const url = config.app.url[config.app.env].microservice_reports + `/api/v1.2/report/taksasi`;
