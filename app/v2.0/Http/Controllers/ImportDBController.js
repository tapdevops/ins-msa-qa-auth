                        ...
                        if (result['TABLE_NAME'] === 'TR_FINDING') {
                            ...
                            data.then( function ( dt ) {
                                dt.forEach(function ( rs ) {
                                    ...
                                    let request = client.post( findingServiceUrl + '/api/v2.0/finding', args, function ( data, response ) {
                            ...
                            data.then( function ( dt ) {
                                dt.forEach( function ( rs ) {
                                    ...
                                    let request = client.post( inspectionServiceUrl + '/api/v2.0/tracking', args, function ( data, response ) {
                            ...
                            data.then( function ( dt ) {
                                dt.forEach( function ( rs ) {
                                    ...
                                    let request = client.post( ebccServiceUrl + '/api/v2.0/ebcc/validation/header', args, function ( data, response ) {
                            ...
                            data.then( function ( dt ) {
                                dt.forEach( function ( rs ) {
                                    ...
                                    let request = client.post( ebccServiceUrl + '/api/v2.0/ebcc/validation/detail', args, function ( data, response ) {
                            ...
                            data.then( function ( dt ) {
                                dt.forEach( function ( rs ) {
                                    ...
                                    let request = client.post( inspectionServiceUrl + '/api/v2.0/detail', args, function ( data, response ) {
                            ...
                            data.then( function ( dt ) {
                                dt.forEach( function ( rs ) {
                                    ...
                                    let request = client.post( inspectionServiceUrl + '/api/v2.0/header', args, function ( data, response ) {
                                        ...
                                        if ( genbaUser ) {
                                            ...
                                            genbaUser.then( function ( rs ) {
                                                ...
                                                if ( userAuthCode.length > 0 ) {
                                                    let request = client.post( inspectionServiceUrl + '/api/v2.0/genba', args, function ( data, response ) {
                            ...
                            results.then( function ( data ) {
                                ...
                                for ( let i = 0; i < data.length; i++ ) {
                                    ...
                                    let request = client.post( imageServiceUrl + '/api/v2.0/auth/upload/image/foto-transaksi', args, function ( data, response ) {
