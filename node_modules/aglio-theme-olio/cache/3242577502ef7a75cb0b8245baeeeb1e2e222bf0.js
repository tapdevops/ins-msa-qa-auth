...
buf.push("<div class=\"resource-group\"><div class=\"heading\"><div class=\"chevron\"><i class=\"open fa fa-angle-down\"></i></div><a" + (jade.attr("href", resourceGroup.elementLink, true, true)) + ">" + (null == (jade_interp = resourceGroup.name || 'Resource Group') ? "" : jade_interp) + "</a></div><div class=\"collapse-content\"><ul>");
...
{
buf.push("<a" + (jade.attr("href", resource.elementLink, true, true)) + ">" + (null == (jade_interp = resource.name || 'Resource') ? "" : jade_interp) + "</a><ul>");
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"title\"><strong>URI Parameters</strong><div class=\"collapse-button show\"><span class=\"close\">Hide</span><span class=\"open\">Show</span></div></div><div class=\"collapse-content\"><dl class=\"inner\">");
// iterate params || []
;(function(){
  var $$obj = params || [];
  if ('number' == typeof $$obj.length) {
...
jade_mixins["RequestResponse"]('Request', request, true);
    }
...
jade_mixins["RequestResponse"]('Response', response, true);
    }
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"middle\"><header><h1 id=\"top\">" + (null == (jade_interp = self.api.name || 'API Documentation') ? "" : jade_interp) + "</h1></header></div><div class=\"right\"><h5>API Endpoint</h5><a" + (jade.attr("href", self.api.host, true, true)) + ">" + (jade.escape(null == (jade_interp = self.api.host) ? "" : jade_interp)) + "</a></div><div class=\"middle\">");
...
buf.push("<div class=\"middle\"><section" + (jade.attr("id", resourceGroup.elementId, true, true)) + " class=\"resource-group\"><h2 class=\"group-heading\">" + (null == (jade_interp = resourceGroup.name || 'Resource Group') ? "" : jade_interp) + (jade.escape(null == (jade_interp = " ") ? "" : jade_interp)) + "<a" + (jade.attr("href", resourceGroup.elementLink, true, true)) + " class=\"permalink\">&para;</a></h2>");
...
{
buf.push("<div class=\"example-names\"><span>Requests</span>");
var requestCount = 0
// iterate action.examples
;(function(){
  var $$obj = action.examples;
...
requestCount++
buf.push("<span class=\"tab-button\">" + (jade.escape(null == (jade_interp = request.name || 'example ' + requestCount) ? "" : jade_interp)) + "</span>");
    }
...
buf.push("<div class=\"tabs\"><div class=\"example-names\"><span>Responses</span>");
// iterate example.responses
;(function(){
  var $$obj = example.responses;
  if ('number' == typeof $$obj.length) {
...
buf.push("</div></div><hr class=\"split\">");
    }
